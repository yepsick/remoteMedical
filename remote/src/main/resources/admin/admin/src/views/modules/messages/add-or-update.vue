  ...
  <div>
    ...
    >
            <el-row>
                                  ...
                                  <el-form-item  v-if="type!='info'"  label="留言人id" prop="userid">
                                      <el-input v-model="ruleForm.userid"
                                                placeholder="留言人id" clearable></el-input>
                                  </el-form-item>
                                  <div v-else>
                                      <el-form-item v-if="ruleForm.userid" label="留言人id" prop="userid">
                                          <el-input v-model="ruleForm.userid"
                                                    placeholder="留言人id" readonly></el-input>
                                      </el-form-item>
                                  </div>
                      </el-col>
                      <el-col :span="12">
